...
mod fire_dragon_batch_test;
#[path = "pokemon/fire_status_and_heatran_test.rs"]
mod fire_status_and_heatran_test;
...
#[path = "pokemon/hand_disruption_no_coin_test.rs"]
mod hand_disruption_no_coin_test;
...
#[path = "pokemon/water_batch_test.rs"]
mod water_batch_test;
